...
use crate::domestic::kis::domestic_stock::Market;
...
impl SubscriptionKind {
    ...
    pub(crate) fn tr_id(self, env: crate::domestic::kis::config::Environment) -> String {
        use crate::domestic::kis::config::Environment::*;
...
mod tests {
    ...
    fn tr_id_synthesis_per_market() {
        use crate::domestic::kis::config::Environment::Real;
