...
use crate::global::mexc::config::MexcConfig;
...
impl MexcClient {
    ...
    /// 시세 도메인 액세서 (키 불필요).
    pub fn market(&self) -> crate::global::mexc::market::Market<'_> {
        crate::global::mexc::market::Market::new(self)
    }

    /// 거래·계좌 도메인 액세서 (HMAC 서명).
    pub fn trade(&self) -> crate::global::mexc::trade::Trade<'_> {
        crate::global::mexc::trade::Trade::new(self)
    }
