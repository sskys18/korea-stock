...
use crate::global::binance::config::BinanceConfig;
...
impl BinanceClient {
    ...
    /// 시세 도메인 액세서 (키 불필요).
    pub fn market(&self) -> crate::global::binance::market::Market<'_> {
        crate::global::binance::market::Market::new(self)
    }

    /// 거래·계좌 도메인 액세서 (HMAC 서명).
    pub fn trade(&self) -> crate::global::binance::trade::Trade<'_> {
        crate::global::binance::trade::Trade::new(self)
    }
