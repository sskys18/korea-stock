...
use crate::global::hyperliquid::config::HyperliquidConfig;
...
impl HyperliquidClient {
    ...
    pub fn market(&self) -> crate::global::hyperliquid::market::Market<'_> {
        crate::global::hyperliquid::market::Market::new(self)
    }

    /// 거래·계좌 도메인 액세서 (`POST /exchange` 서명 + `POST /info` 조회 혼합).
    pub fn trade(&self) -> crate::global::hyperliquid::trade::Trade<'_> {
        crate::global::hyperliquid::trade::Trade::new(self)
    }
    ...
    /// 반환한다.
    ///
    /// action(예: [`crate::global::hyperliquid::trade::OrderAction`])은 wire 필드 순서를
