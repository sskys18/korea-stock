...
//! 구현한다. 서버가 막혀 있으면 MEXC의 점검 에러([`crate::global::mexc::MexcError::Api`])가 그대로
//! 반환된다(허구 스텁이 아님 — Rule 3 준수). 조회(포지션·자산·주문)는 정상 동작한다.

use serde::Deserialize;
use serde_json::json;

use crate::global::mexc::client::{ApiCall, MexcClient};
use crate::global::mexc::error::Result;
use crate::global::mexc::market::num_or_str;
...
impl<'a> Trade<'a> {
    ...
    /// MEXC 점검 에러([`crate::global::mexc::MexcError::Api`])가 반환될 수 있다. 성공 시 data는
