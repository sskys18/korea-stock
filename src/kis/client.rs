...
impl KisClient {
    ...
    /// 국내주식 도메인 액세서.
    pub fn domestic_stock(&self) -> crate::kis::domestic_stock::DomesticStock<'_> {
        crate::kis::domestic_stock::DomesticStock::new(self)
    }

    /// 해외주식 도메인 액세서.
    pub fn overseas_stock(&self) -> crate::kis::overseas_stock::OverseasStock<'_> {
        crate::kis::overseas_stock::OverseasStock::new(self)
    }

    /// 국내선물옵션 도메인 액세서.
    pub fn futureoption(&self) -> crate::kis::futureoption::FutureOption<'_> {
        crate::kis::futureoption::FutureOption::new(self)
    }
    ...
    pub async fn realtime(&self) -> Result<crate::kis::realtime::RealtimeClient> {
        crate::kis::realtime::RealtimeClient::connect(self.config.clone(), self.http.clone()).await
    }
