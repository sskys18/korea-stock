...
use crate::lighter::config::LighterConfig;
...
impl LighterClient {
    ...
    /// 시세 도메인 액세서 (키 불필요).
    pub fn market(&self) -> crate::lighter::market::Market<'_> {
        crate::lighter::market::Market::new(self)
    }

    /// 거래·계좌 도메인 액세서 (서명 미검증 — 제출은 차단).
    pub fn trade(&self) -> crate::lighter::trade::Trade<'_> {
        crate::lighter::trade::Trade::new(self)
    }
