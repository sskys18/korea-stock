...
//!    서명. 자세한 명세는 [`crate::hyperliquid::client`]의 `sign_l1_action` 참조.
//!
//! ## HIP-3 자산 식별
...
//!
//! ```ignore
//! use korea_stock::hyperliquid::{HyperliquidClient, HyperliquidConfig, SAMSUNG};
//! use korea_stock::hyperliquid::trade::{OrderRequest, Tif};
//!
//! // 시세 — 키 불필요.
